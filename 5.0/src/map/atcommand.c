...
ACMD_FUNC(trade)
{
	...
	if( sd->state.account_protection ) {
		clif_displaymessage(fd, "Your Account is Locked.");
		return false;
	}
...
ACMD_FUNC(rates)
{
	...
	{
		snprintf(buf, CHAT_SIZE_MAX, msg_txt(sd,1497), // Drop Zeny Rates: Normal %.2fx / Boss %.2fx
