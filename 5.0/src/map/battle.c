...
int battle_check_target( struct block_list *src, struct block_list *target,int flag)
{
	...
	switch( src->type ) { //Checks on actual src type
		case BL_PET:
			if (battle_config.duel_allow_pvp || map[m].flag.pvp)
				return 0; //Pet may not attack in pvp by mocha gang
...
// rAthena
	...
	{ "vending_price_min_overflow",                &battle_config.vending_price_min_overflow,             0,      0,      10000              },
	...
	{ "zeny_from_mobs_rate",                &battle_config.zeny_from_mobs_rate,            100,    0,    MAX_ZENY_FROM_MOBS_RATE,      },
	{ "zeny_from_boss_rate",                &battle_config.zeny_from_boss_rate,            100,    0,    MAX_ZENY_FROM_MOBS_RATE,      },
};
